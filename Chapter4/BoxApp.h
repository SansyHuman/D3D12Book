...
#ifndef D3D12BOOK_BOXAPP_H
#define D3D12BOOK_BOXAPP_H
...
bool BoxApp::Initialize(const D3DApp::D3DAPP_SETTINGS& settings)
{
...
void BoxApp::Update(GameTimer<float>& gt)
{
...
void BoxApp::Draw(const GameTimer<float>& gt)
{
    ...
    DirectXHelper::MeshGeometry::SubmeshGeoemtry box = mBoxGeo->DrawArgs[L"상자"];
...
void BoxApp::BuildBoxGeometry()
{
    ...
    DirectXHelper::MeshGeometry::SubmeshGeoemtry submesh = {};

...
#ifndef D3D12BOOK_TEXWAVESAPP_H
#define D3D12BOOK_TEXWAVESAPP_H
...
bool TexWavesApp::Initialize(const D3DApp::D3DAPP_SETTINGS& settings)
{
...
void TexWavesApp::Update(GameTimer<float>& gt)
{
    OnKeyboardInput(gt);
    UpdateCamera(gt);
...
void TexWavesApp::Draw(const GameTimer<float>& gt)
{
...
void TexWavesApp::OnKeyboardInput(const GameTimer<float>& gt)
{
...
void TexWavesApp::UpdateCamera(const GameTimer<float>& gt)
{
...
void TexWavesApp::AnimateMaterials(const GameTimer<float>& gt)
{
...
void TexWavesApp::UpdateObjectCBs(const GameTimer<float>& gt)
{
...
void TexWavesApp::UpdateMaterialCBs(const GameTimer<float>& gt)
{
...
void TexWavesApp::UpdateMainPassCB(const GameTimer<float>& gt)
{
...
void TexWavesApp::UpdateWaves(const GameTimer<float>& gt)
{
...
void TexWavesApp::BuildGeometry()
{
    {
...
void TexWavesApp::BuildMaterials()
{
    ...
    water->DiffuseAlbedo = float4(1.0f, 1.0f, 1.0f, 1.0f);
...
float3 TexWavesApp::GetHillsNormal(float x, float z) const
{
    float3 n(
